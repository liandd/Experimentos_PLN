...
<node TEXT="Python Polyglot library" FOLDED="true" ID="ID_1168167197" CREATED="1725219956408" MODIFIED="1725220076138" HGAP_QUANTITY="-43.75 pt" VSHIFT_QUANTITY="22.5 pt">
<font BOLD="true"/>
...
<node TEXT="Debido a que los corpus son de pocas muestras utiliza Rasa Natural Language Understanding" ID="ID_971110734" CREATED="1725219700008" MODIFIED="1725984494565" HGAP_QUANTITY="11.75 pt">
<node TEXT="clasificación de intenciones y entidades" ID="ID_877854306" CREATED="1725980852292" MODIFIED="1725980853670"/>
</node>
...
<node TEXT="low: Indica si un término está en minúsculas." ID="ID_1882116617" CREATED="1725980875546" MODIFIED="1725980876923"/>
<node TEXT="title: Señala si la palabra comienza con una letra mayúscula" ID="ID_1384345703" CREATED="1725980882255" MODIFIED="1725980888188"/>
<node TEXT="upper: Indica si una palabra está completamente en mayúsculas." ID="ID_1699171758" CREATED="1725980888624" MODIFIED="1725980896487"/>
<node TEXT="BOS (Beginning of Sentence): Detecta si el término está al inicio de una oración" ID="ID_1928015575" CREATED="1725980897385" MODIFIED="1725980898400"/>
<node TEXT="EOS (End of Sentence): Detecta si el término está al final de una oración" ID="ID_1706669614" CREATED="1725980904354" MODIFIED="1725980909650"/>
<node TEXT="digit: Verifica si el término es un número." ID="ID_1314015979" CREATED="1725980910743" MODIFIED="1725980911913"/>
<node TEXT="pos (Part of Speech): Clasifica la categoría gramatical de la palabra (sustantivo, verbo, adjetivo, etc.)." ID="ID_1874116501" CREATED="1725980917369" MODIFIED="1725980918880"/>
</node>
</node>
</node>
</node>
</node>
<node TEXT="Las puntuaciones de confianza de las muestras evaluadas superen el umbral (1 − 0. 2^n)," ID="ID_915984934" CREATED="1725218539281" MODIFIED="1725980569224">
<node TEXT="Muestras no supervisadas de Reddit que fueron aceptadas se agregan al corpus supervisado" ID="ID_1193875476" CREATED="1725218606644" MODIFIED="1725980588777" HGAP_QUANTITY="59.75 pt" VSHIFT_QUANTITY="49.5 pt">
...
<node TEXT="El 1 representa el 100%, el -0.2 reduce el total de muestras aceptadas mientras el modelo avanza en iteraciones,(solo aceptar las de alto nivel de confianza), y el clasificador requiere una mayor confianza para aceptar una muestra entonces 0.2^n" ID="ID_197213223" CREATED="1725980451617" MODIFIED="1725980572194"/>
</node>
</node>
...
<node TEXT="En cada iteración, se utiliza 1 fold como conjunto de prueba (test set) y los otros 9 folds como conjunto de entrenamiento (training set)." ID="ID_1617346450" CREATED="1725980658150" MODIFIED="1725980659626"/>
</node>
<node TEXT="cuán bien puede predecir sobre datos que no han sido utilizados durante su entrenamiento" ID="ID_662393836" CREATED="1725980635883" MODIFIED="1725980639497"/>
<node TEXT="evaluar el rendimiento de un modelo en situaciones donde los datos son limitados" ID="ID_1267226867" CREATED="1725980710260" MODIFIED="1725980711578"/>
</node>
</node>
</node>
</node>
